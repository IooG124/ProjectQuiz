    ...
    <x-navbar>
        <div class="container mx-auto flex  items-center">
            <div class="flex items-center">
                <h1 class="text-2xl font-bold ml-7 mr-2 text-white"></h1>
    ...
    <div class="container w-1/2  mx-auto p-8 rounded-lg shadow-lg bg-white mt-10 mb-20 ">
      <div class="mx-auto">
        ...
        <div class="p-2 bg-white rounded-lg w-3xl ">
          ...
          <form id="quizzForm" method="POST" action="/{{ $quiz->id }}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="mb-4">
            ...
            <div class="p-4 bg-white rounded-lg shadow-lg col-span-1 md:col-span-1 cols-end ">
                <div class="mb-2">
                    ...
                    <div class="flex flex-col items-center justify-center relative w-full h-80 border border-gray-300 rounded-lg">
                        <img src="{{ asset('storage/' . $quiz->gambar_profil) }}" alt="Gambar Profil" id="previewImage" class=" w-full h-full object-cover aspect-video">
                        <input type="file" value="{{ old('gambar_profil', $quiz->gambar_profil) }}" name="gambar_profil" id="imageInput" class="" >
                    </div>
