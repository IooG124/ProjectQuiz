...
<body class="bg-teal-700 font-inter flex flex-col justify-center items-center min-h-screen">
  <div class="w-2/4 flex"> 
    <div class="w-1/5">
      <div class="rounded overflow-hidden shadow-lg bg-white p-3">
        <div class="flex items-center px-4 py-2">
          <img class="w-36 h-28 items-center" src="https://placehold.co/250x200" alt="Quiz Image">
          <div class="ml-4">
        ...
        <div class="px-6 py-1">
            <button class="bg-teal-700 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline text-md">
    ...
    <div class="w-2/3 ml-10">
      <div class="w-full rounded-lg p-4 bg-gray-100 shadow-md">
    ...
    <div class="w-full rounded-lg p-4 bg-gray-100 shadow-md  mt-10">
    ...
    <h2 class="text-xl font-bold mb-4 mx-auto w-full mt-10 text-white">Settings</h2>
    <div class="w-full rounded-lg p-4 bg-gray-100 shadow-md ">
      <div class="flex items-center justify-between mb-2">
        <span>Music</span>
        <label class="relative inline-flex items-center cursor-pointer">
          <input type="checkbox" value="" class="sr-only peer" id="music-toggle">
          <div class="w-11 h-6 bg-gray-200 rounded-full peer focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-teal-700 peer-checked:bg-teal-700 peer-checked:shadow-lg  peer-focus:ring-teal-700 dark:peer-checked:bg-teal-700 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all after:duration-300 after:ease-in-out"></div>
        </label>
      </div>
